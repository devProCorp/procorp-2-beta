...
const translations: Record<string, Record<Language, string>> = {
    ...
    'home.badge': { en: 'Our Evolution', es: 'Nuestra Evolución' },
    'home.title1': { en: 'From Legal Services', es: 'De Servicios Legales' },
    'home.title2': { en: 'to Technology Engineering', es: 'a la Ingeniería Tecnológica' },
    'home.desc': { en: 'Our immigration and legal services remain a fundamental pillar, now enhanced with Artificial Intelligence and process automation (BPA) to deliver unprecedented agility in the corporate architecture of the future.', es: 'Nuestros servicios de trámites migratorios y legales continúan siendo un pilar fundamental, ahora potenciados con Inteligencia Artificial y automatización de procesos (BPA) para ofrecer una agilidad sin precedentes en la arquitectura corporativa del futuro.' },
