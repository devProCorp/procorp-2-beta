...
const translations: Record<string, Record<Language, string>> = {
    ...
    'home.badge': { en: 'Corporate Development & Structuring', es: 'Desarrollo Corporativo y Estructuración' },
    ...
    'home.tagline': { en: 'Legal structuring, process automation and strategic investment for companies seeking to grow with order, compliance and technology.', es: 'Estructuración legal, automatización de procesos e inversión estratégica para empresas que buscan crecer con orden, cumplimiento y tecnología.' },
    'home.desc': { en: 'From immigration services and corporate governance to process re-engineering and intelligent automation (BPA), we offer an integrated model that combines legality, strategy and technology to deliver measurable results.', es: 'Desde servicios migratorios y gobernanza corporativa hasta reingeniería de procesos y automatización inteligente (BPA), ofrecemos un modelo integrado que combina legalidad, estrategia y tecnología para entregar resultados medibles.' },
    ...
    'about.desc': { en: 'We help companies structure their legal operations, automate processes, and grow sustainably. Whether you need immigration management, corporate governance, or digital transformation, we build the systems so you can focus on your business.', es: 'Ayudamos a empresas a estructurar sus operaciones legales, automatizar procesos y crecer de forma sostenible. Ya sea que necesites gestión migratoria, gobernanza corporativa o transformación digital, construimos los sistemas para que te enfoques en tu negocio.' },
    'about.mission.title': { en: 'What do we solve for you?', es: '¿Qué resolvemos para ti?' },
    'about.mission.desc': { en: 'At Pro Corp, we eliminate the operational friction that slows down your growth. From legal structuring and regulatory compliance to process automation and strategic investment, we take on the complex work so you get clear results: fewer delays, less risk, and a business that scales.', es: 'En Pro Corp, eliminamos la fricción operativa que frena tu crecimiento. Desde la estructuración legal y el cumplimiento normativo hasta la automatización de procesos e inversión estratégica, asumimos el trabajo complejo para que obtengas resultados claros: menos demoras, menos riesgo y un negocio que escala.' },
