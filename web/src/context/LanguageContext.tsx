...
const translations: Record<string, Partial<Record<Language, string>>> = {
    ...
    'lia.chat.lia3': {
        en: 'The Value Finding Cycle is already in motion: Understand → Model → Simulate → Redesign → Automate → Build → Continuous Monitoring → Learn. I\'ll have your architecture blueprint ready for review by next week.',
        es: 'El Ciclo de Descubrimiento de Valor ya está en marcha: Entender → Modelar → Simular → Rediseñar → Automatizar → Construir → Monitoreo Continuo → Aprender. Tendré el plano de tu arquitectura listo para revisión la próxima semana.',
        pt: 'O Ciclo de Descoberta de Valor já está em andamento: Entender → Modelar → Simular → Redesenhar → Automatizar → Construir → Monitoramento Contínuo → Aprender. Terei o plano da sua arquitetura pronto para revisão na próxima semana.'
    },
    ...
    'studio.desc2': { en: 'Business Process mapping, Re-engineering, simulation, automation (BPA) and monitoring. We transform operational friction into a predictable and automated growth architecture.', es: 'Mapeo, Reingeniería, simulación, automatización (BPA) y monitoreo de Procesos de Negocio. Transformamos la fricción operativa en una arquitectura de crecimiento predecible y automatizada.', pt: 'Mapeamento, Reengenharia, simulação, automação (BPA) e monitoramento de Processos de Negócio. Transformamos a fricção operacional em uma arquitetura de crescimento previsível e automatizada.' },
    ...
    'about.step5': { en: 'Automate', es: 'Automatizar', pt: 'Automatizar' },
    'about.step5.desc': { en: 'The redesigned processes into reliable automated flows.', es: 'Los procesos rediseñados en flujos automatizados confiables.', pt: 'Os processos redesenhados em fluxos automatizados confiáveis.' },
    'about.step6': { en: 'Build', es: 'Construir', pt: 'Construir' },
    'about.step6.desc': { en: 'Workflows, structures and tools that hold.', es: 'Flujos, estructuras y herramientas que aguantan.', pt: 'Fluxos, estruturas e ferramentas que aguentam.' },
    'about.step7': { en: 'Continuous Monitoring', es: 'Monitoreo Continuo', pt: 'Monitoramento Contínuo' },
    'about.step7.desc': { en: 'What changed, against the baseline.', es: 'Qué cambió, contra la línea base.', pt: 'O que mudou, contra a linha de base.' },
    'about.step8': { en: 'Learn', es: 'Aprender', pt: 'Aprender' },
    'about.step8.desc': { en: 'Feed results back into the next cycle.', es: 'Devolver los resultados al siguiente ciclo.', pt: 'Devolver os resultados ao próximo ciclo.' },
    ...
    'about.desc2': { en: 'Technology is the instrument.\nAI is the accelerator.\nSimulation is understanding.\nMonitoring while Executing is the differentiator.', es: 'La tecnología es el instrumento.\nLa IA es el acelerador.\nLa simulación es entendimiento.\nMonitorear mientras se ejecuta es el diferenciador.', pt: 'A tecnologia é o instrumento.\nA IA é o acelerador.\nA simulação é entendimento.\nMonitorar enquanto se executa é o diferenciador.' },
