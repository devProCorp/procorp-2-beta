...
const translations: Record<string, Partial<Record<Language, string>>> = {
    ...
    'about.desc': { en: 'Business Engineering is built with the client, not around them.\n\nThe client knows the reality of their business. PRO CORP brings the method to challenge it, understand it, simulate alternatives, and transform it. Leadership, the client’s team, and PRO CORP work together on the decisions that matter.\n\nClient participation is not consultation. It is part of the engineering.', es: 'La Ingeniería de Negocios se construye con el cliente, no alrededor de él.\n\nEl cliente conoce la realidad de su negocio. PRO CORP aporta el método para cuestionarla, entenderla, simular alternativas y transformarla. La dirección, el equipo del cliente y PRO CORP trabajan juntos en las decisiones que importan.\n\nLa participación del cliente no es una consulta. Es parte de la ingeniería.', pt: 'A Engenharia de Negócios se constrói com o cliente, não ao redor dele.\n\nO cliente conhece a realidade do seu negócio. A PRO CORP traz o método para desafiá-la, entendê-la, simular alternativas e transformá-la. A liderança, a equipe do cliente e a PRO CORP trabalham juntas nas decisões que importam.\n\nA participação do cliente não é consulta. É parte da engenharia.' },
