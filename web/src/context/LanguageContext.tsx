...
const translations: Record<string, Record<Language, string>> = {
    ...
    'about.desc': { en: 'Business Engineering means redesigning how your company operates — from legal structure to automated workflows to strategic investment. We handle the complexity so you focus on growing.', es: 'Ingeniería de Negocios significa rediseñar cómo opera tu empresa — desde la estructura legal hasta flujos automatizados e inversión estratégica. Nosotros manejamos la complejidad para que tú te enfoques en crecer.' },
    ...
    'about.method.desc': { en: 'Our Business Engineering methodology follows a 5-step process designed to eliminate uncertainty and maximize return.', es: 'Nuestra metodología de Ingeniería de Negocios sigue un proceso de 5 pasos diseñado para eliminar la incertidumbre y maximizar el retorno.' },
    ...
    'about.stat3.label': { en: 'Engineering', es: 'Ingeniería' },
    'about.stat4.label': { en: 'BPA Steps', es: 'Pasos BPA' },
