  ...
  return (
    <main className="min-h-screen bg-background-dark pb-20">
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-10 lg:px-20 py-8">
        ...
        <section className="rounded-2xl bg-white border border-black/10 p-8 md:p-12 relative overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-2xl md:text-3xl font-bold text-[#1a1a1a] mb-3">Suscríbete a nuestra visión estratégica</h2>
              <p className="text-[#666] font-light">Recibe análisis profundo sobre ingeniería de procesos y tendencias legales.</p>
            </div>
            <div className="w-full md:w-auto flex flex-col sm:flex-row gap-3">
              <input
                className="h-12 px-4 rounded-lg bg-[#f5f5f5] border border-black/10 text-[#1a1a1a] placeholder:text-[#999] focus:border-primary focus:ring-1 focus:ring-primary outline-none min-w-[300px]"
